...
type CategoryService_CreateCategoryStreamClient interface {
	...
	CloseAndRecv() (*CategoriesList, error)
	grpc.ClientStream
}
...
func (x *categoryServiceCreateCategoryStreamClient) CloseAndRecv() (*CategoriesList, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(CategoriesList)
...
type CategoryService_CreateCategoryStreamServer interface {
	SendAndClose(*CategoriesList) error
...
func (x *categoryServiceCreateCategoryStreamServer) SendAndClose(m *CategoriesList) error {
